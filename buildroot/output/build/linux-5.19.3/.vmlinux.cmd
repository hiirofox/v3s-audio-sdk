cmd_vmlinux := sh scripts/link-vmlinux.sh "/home/hiirofox/v3s-sdk/buildroot/output/host/bin/arm-buildroot-linux-gnueabihf-ld" "-EL -z noexecstack --no-warn-rwx-segments" "--no-undefined -X --pic-veneer -z norelro --build-id=sha1 --orphan-handling=warn";  true
