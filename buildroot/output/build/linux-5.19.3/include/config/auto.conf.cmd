...
ifneq "$(KERNELVERSION)" "5.19.3"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/hiirofox/v3s-sdk/buildroot/output/host/bin/arm-buildroot-linux-gnueabihf-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/hiirofox/v3s-sdk/buildroot/output/host/bin/arm-buildroot-linux-gnueabihf-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-buildroot-linux-gnueabihf-gcc.br_real (Buildroot 2024.08) 13.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/hiirofox/v3s-sdk/buildroot/output/host/bin/arm-buildroot-linux-gnueabihf-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/hiirofox/v3s-sdk/buildroot/output/host/bin/arm-buildroot-linux-gnueabihf-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "/home/hiirofox/v3s-sdk/buildroot/output/host/bin/arm-buildroot-linux-gnueabihf-ar"
include/config/auto.conf: FORCE
endif
